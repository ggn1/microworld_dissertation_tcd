...
const Help = () => {
    ...
    const setNodesLinks = (challengeNum) => {
        ...
        let nodesNew = []
        let linksNew = []
        if ([1, 2, 3, 4, 5].includes(challengeNum)) {
            nodesNew = [
                { id: 0, content: [["heading", "WORLD"], ["paragraph", "This microworld contains a single forest. You are now the owner of this forest. The forest helps keep CO2 levels in the air in check and also acts as a source of wood. Please note that the virtual forest presented does not reflect any single real-world forest, it is a simplified, abstract representation of all forests on Earth."]] },
