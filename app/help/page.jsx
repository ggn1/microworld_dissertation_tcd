...
const Help = () => {
    ...
    const setNodesLinks = (challengeNum) => {
        ...
        let nodesNew = []
        let linksNew = []
        if ([0, 1, 2, 3].includes(challengeNum)) {
            nodesNew = [
